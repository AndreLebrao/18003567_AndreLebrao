...
fun somar3(numero1: Int = 0, numero2: Int = 0) = numero1+numero2
fun main() {
    val num1 = 10
    val num2 = 25
    println("Retorno da soma: ${somar(num1,num2)}")
    println("Retorno da soma: ${somar2(num1,num2)}")
    println("Retorno da soma: ${somar2(num1)}")
    println("Retorno da soma: ${somar2(numero2 = num2)}")
    println("Retorno da soma: ${somar3(numero1 = num1,numero2 = num2)}")
    println("Retorno da soma: ${somar3(numero1 = num2,numero2 = num1)}")
}